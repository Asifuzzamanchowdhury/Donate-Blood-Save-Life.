...
void SIGN_IN()
{
      ...
      void USER()
 {
      ...
      printf("\n d. Cautions before Blood Donation  \n");
      printf("\n e. Cautions During Blood Donation  \n");
      printf("\n f. Cautions After Blood Donation   \n");
      printf("\n g. Cautions before taking Blood    \n");
      printf("\n h. Quiz                            \n");
      printf("\n i. Back to the Menu                \n");
      printf("\n j. Exit                            \n");
...
void NEED_BLOOD_X()
{
 ...
 void SAVAR_N()
  ...
  void BEFORE_DONATION()
  {
       ...
       system (" cls ");
       printf("\n                      Cautions before Blood Donation                    \n\n");
       printf("==========================================================================\n\n");
    ...
    {
       system (" cls ");
       printf("\n                       Cautions during Blood Donation                   \n\n");
       printf("==========================================================================\n\n");
...
{
    system (" cls ");
    struct NSU programmer[1] = {{"Md. Asif Uzzaman Chowdhury","North South University", 1632090042,"CSE" ,"ECE"}};
    int x;
    printf("\n\n----------------------About Programmer-------------------------\n\n");
    for(x=0;x<1;x++)
